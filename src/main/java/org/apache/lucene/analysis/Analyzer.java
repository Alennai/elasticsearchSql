...
public abstract class Analyzer implements Closeable {
     ...
     * use a subclass of {@link } such as
     ...
     * @throws  if the Analyzer is closed.
    ...
    /** Wrap the given {@link Reader} with {@link }s that make sense
     *  for normalization. This is typically a subset of the {@link }s
     ...
     * instance of {@link } which also serves as the
